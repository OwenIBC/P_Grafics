...
void CrearDado()
{
	...
	GLfloat cubo_vertices[] = {
		...
		0.5f,  0.5f,  0.5f,		0.49f,	0.66f,		0.0f,	0.0f,	1.0f,
...
int main()
{
	...
	glm::vec3 direccionPiso(0.0f, -1.0f, 0.0f);
	glm::mat4 model(1.0f);
	...
	glm::vec4 localHeadlightDir(0.0f, -1.0f, 0.0f, 0.0f);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		posHelicoptero = glm::vec3(heliX, 5.0f, 6.0f);
		spotLights[2].SetFlash(posHelicoptero, direccionPiso);
